...
class ProductConversionUnitFormCard extends StatefulWidget {
  const ProductConversionUnitFormCard({
    super.key,
    required this.draft,
  ...
  @override
  State<ProductConversionUnitFormCard> createState() =>
      _ProductConversionUnitFormCardState();
}

class _ProductConversionUnitFormCardState
    extends State<ProductConversionUnitFormCard> {
  ...
  void initState() {
    ...
    _factorController = TextEditingController(
      text: _formatFactor(widget.draft.conversionFactor),
    );
    _priceController = TextEditingController(text: _formatPrice());
  }

  @override
  void didUpdateWidget(ProductConversionUnitFormCard oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.draft.conversionFactor != widget.draft.conversionFactor) {
      _factorController.text = _formatFactor(widget.draft.conversionFactor);
    }
