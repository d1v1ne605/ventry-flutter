    ...
    return BlocListener<CategoryBloc, CategoryState>(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _isEdit ? AppStrings.categoryEditTitle : AppStrings.categoryNewTitle,
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  child: Text(
                    ...
                    style: AppTextStyles.buttonText.copyWith(color: AppColors.heading),
                  ),
                ),
              ),
                ...
                child: BlocSelector<CategoryBloc, CategoryState, bool>(
                  ...
                  builder: (context, isSubmitting) {
                    return ElevatedButton(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                          gradient: isSubmitting ? null : AppColors.primaryGradient,
                        ...
                        child: Container(
                          ...
                          child: isSubmitting
                              ...
                              : Text(
                                  _isEdit ? AppStrings.categoryUpdateTitle : AppStrings.categorySaveTitle,
                                  style: AppTextStyles.buttonText.copyWith(
                                    color: isSubmitting ? AppColors.subtitle : Colors.white,
                                  ),
                                ),
                        ),
                      ),
